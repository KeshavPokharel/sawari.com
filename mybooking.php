    ...
    <section id="about" class="about mt-4 mx-4">
        ...
        if (isset($_COOKIE['auth_token'])) {
            ...
            if ($result->num_rows > 0) {
                ...
                $ride_query = "SELECT * FROM ride_requests WHERE user_id = $user_id AND status = 'accepted' ORDER BY request_id DESC LIMIT 10";
                ...
                if ($ride_result->num_rows > 0) {
                    ...
                    while ($ride_row = $ride_result->fetch_assoc()) {
                        ...
                        if ($result && $result->num_rows > 0) {
                            $row = $result->fetch_assoc();
                            $RiderFullName = $row['fullname'];
                            $number=$row['phone'];
                        } else {
                            $RiderFullName = "Unknown Rider";
                        }
                        ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td colspan="6" class="text-center">
                                            <?php 
                                                ...
                                                echo '<p class="text-success">Your request has been accepted for '; echo $RiderFullName; echo ' , happy ride</p>';
